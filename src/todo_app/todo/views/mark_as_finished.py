...
def mark_as_finished_view(request: HttpRequest, task_id: str) -> HttpResponseRedirect:
    """View for marking a task with given ID as finished.
    ...
    Args:
        ...
        task_id (str): The ID of the task to mark as finished.
